...
class ImagePickerConfigs {
  //he default constructor is a factory that returns the configuration
  //ingleton of the picker configuration.
  ...
  // Enable this option to allow image pre-processing, such as cropping, after editing.
  ...
  // button than enables users switch camera, then set [showLensDirection] to false.
  ...
  String get textAlbumTitle =>
      getTranslatedString("image_picker_album_title", "Gallery");
